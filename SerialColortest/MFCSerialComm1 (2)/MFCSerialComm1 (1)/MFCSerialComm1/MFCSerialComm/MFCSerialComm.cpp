...
// MFCSerialComm.cpp : Defines the class behaviors for the application.
//
...
// CMFCSerialCommApp construction
...
// The one and only CMFCSerialCommApp object

CMFCSerialCommApp theApp;


// CMFCSerialCommApp initialization
